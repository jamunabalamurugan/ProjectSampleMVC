...
namespace Rash_Airlines.Models
{
    ...
    public partial class Rash_AirlinesEntities : DbContext
    {
        ...
        public virtual DbSet<Passengers_Details_New> Passengers_Details_New { get; set; }
        ...
        public virtual ObjectResult<search_flight1_Result> search_flight1(Nullable<int> dept, Nullable<int> arr, Nullable<System.DateTime> journey_date)
        {
            var deptParameter = dept.HasValue ?
                new ObjectParameter("dept", dept) :
                new ObjectParameter("dept", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<search_flight1_Result>("search_flight1", deptParameter, arrParameter, journey_dateParameter);
        }
    
        public virtual ObjectResult<search_flight2_Result> search_flight2(Nullable<int> dept, Nullable<int> arr, Nullable<System.DateTime> journey_date)
        {
            var deptParameter = dept.HasValue ?
                new ObjectParameter("dept", dept) :
                new ObjectParameter("dept", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<search_flight2_Result>("search_flight2", deptParameter, arrParameter, journey_dateParameter);
        }
    }
}
