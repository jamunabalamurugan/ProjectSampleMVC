...
namespace Rash_Airlines.Controllers
{
    public class Flights_ScheduleController : Controller
    {
        ...
        public ActionResult Details(DateTime? journey_date, int? flight_id)
        {
        ...
        public ActionResult Create([Bind(Include = "route_id,departure_time,arrival_time,duration,flight_id,journey_date,bc_availability,ec_availability")] Flights_Schedule flights_Schedule)
        {
        ...
        public ActionResult Edit(DateTime? journey_date,int? flight_id)
        {
            if (flight_id == null || journey_date == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "route_id,departure_time,arrival_time,duration,flight_id,journey_date,bc_availability,ec_availability")] Flights_Schedule flights_Schedule)
        {
            if (ModelState.IsValid)
            {
        ...
        public ActionResult Delete(DateTime? journey_date, int? flight_id)
        {
            if (flight_id == null || journey_date == null)
            {
                return new HttpStatusCodeResult(HttpStatusCode.BadRequest);
