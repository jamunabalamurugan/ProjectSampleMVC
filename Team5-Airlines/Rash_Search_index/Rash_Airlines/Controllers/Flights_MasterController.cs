...
namespace Rash_Airlines.Controllers
{
    public class Flights_MasterController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "flight_id,flight_name,business_capacity,economy_capacity,route_id,flight_status")] Flights_Master flights_Master)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "flight_id,flight_name,business_capacity,economy_capacity,route_id,flight_status")] Flights_Master flights_Master)
        {
            if (ModelState.IsValid)
            {
